...
class SaveUpdateStockRTViewModel : ViewModel() {
    ...
    fun saveUpdateStockRT(context: Context,FK_BranchFrom : String,FK_DepartmentFrom : String,FK_EmployeeFrom : String,STRequest : String,strDate : String,
    FK_BranchTo : String,FK_DepartmentTo : String,FK_EmployeeTo : String,TransMode : String,FK_StockRequest : String,ID_StockTransfer : String,
        ...
        saveUpdateStockRTData = SaveUpdateStockRTRepository.getServicesApiCall(context, FK_BranchFrom!!,FK_DepartmentFrom!!,FK_EmployeeFrom!!,STRequest,strDate,
