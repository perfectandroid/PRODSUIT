...
class CustomerServiceRegisterViewModel: ViewModel()  {
    ...
    fun getcusServRegister(context: Context,strUserAction : String,Customer_Type : String,ID_Customer : String,ID_Channel : String,ID_Priority : String,
                           ...
                           strDate : String,strTime : String,FK_Country : String,FK_States : String,FK_District : String,FK_Area : String,FK_Post : String,FK_Place : String,ID_CompCategory :String) : LiveData<CustomerServiceRegisterModel>? {
