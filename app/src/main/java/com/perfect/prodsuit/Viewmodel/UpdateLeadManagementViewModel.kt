...
class UpdateLeadManagementViewModel  : ViewModel(){
    ...
    fun getUpdateLeadManagement(context: Context,ID_LeadGenerateProduct :String,ID_LeadGenerate :String,ID_ActionType :String,ID_Employee :String,ID_Status :String,strFollowUpDate :String,
                                ...
                                ID_Department :String,ID_NextEmployee :String, strCallStatus: String?,strCallDuration: String?,strLatitude: String?,strLongitude: String?,encode1: String?,encode2: String?) : LiveData<UpdateLeadManagementModel>? {
        updateLeadManagementLiveData = UpdateLeadManagementRepository.getServicesApiCall(context,ID_LeadGenerateProduct,ID_LeadGenerate,ID_ActionType,ID_Employee,ID_Status,strFollowUpDate,
