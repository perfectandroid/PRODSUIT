...
//            Log.e("LeadGenerateSaveViewModel"," 2266662    ")
    ...
    ID_BranchType :String,ID_Department :String,ID_Employee :String,strLatitude :String,strLongitue :String, encode1 :String, encode2 :String) : LiveData<LeadGenerateSaveModel>? {
        Log.e("LeadGenerateSaveViewModel"," 2266661    ")
