...
class AuthCorrectionViewModel : ViewModel() {
    ...
    fun getAuthCorrection(context: Context, AuthID : String) : LiveData<AuthCorrectionModel>? {
        authCorrectionData = AuthCorrectionRepository.getServicesApiCall(context,AuthID)
