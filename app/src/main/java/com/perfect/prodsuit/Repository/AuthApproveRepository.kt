...
//               {"BankKey":"-500","Token":"F5517387-B815-4DCC-B2CC-E0A2F3160E22","FK_Company":"1","AuthID":"12399","EntrBy":"riyaske"}
                ...
                Log.e(TAG,"81 saveAuthorizationApproveUpdate  "+requestObject1)
            } catch (e: Exception) {
                e.printStackTrace()
            }
            ...
            val call = apiService.saveAuthorizationApproveUpdate(body)
            call.enqueue(object : retrofit2.Callback<String> {
                override fun onResponse(
                    ...
                    try {
                        ...
                        val leads = ArrayList<AuthApproveModel>()
                        leads.add(AuthApproveModel(response.body()))
                        val msg = leads[0].message
                        authApproveSetterGetter.value = AuthApproveModel(msg)
                    } catch (e: Exception) {
                        progressDialog!!.dismiss()
