...
object MaterialUsageTeamRepository {
            ...
            call.enqueue(object : retrofit2.Callback<String> {
                override fun onResponse(
                    ...
                    try {
                        ...
                        val leads = ArrayList<MaterialUsageTeamModel>()
                        leads.add(MaterialUsageTeamModel(response.body()))
                        val msg = leads[0].message
                        MaterialUsageteamSetterGetter.value = MaterialUsageTeamModel(msg)
                    } catch (e: Exception) {
                        progressDialog!!.dismiss()
