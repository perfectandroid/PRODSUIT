...
object EmployeeWiseRepository {

    private var progressDialog: ProgressDialog? = null
    val employeewiseSetterGetter = MutableLiveData<EmployeewiseModel>()
    val TAG: String = "EmployeeWiseRepository"

    fun getServicesApiCall(context: Context): MutableLiveData<EmployeewiseModel> {
          getEmployeewiseGraph(context)
        return employeewiseSetterGetter
    }

    private fun getEmployeewiseGraph(context: Context) {
        try {
            employeewiseSetterGetter.value =EmployeewiseModel("")
            ...
            call.enqueue(object : retrofit2.Callback<String> {
                override fun onResponse(
                    ...
                    try {
                        ...
                        employeewiseSetterGetter.value = EmployeewiseModel(msg)
                    } catch (e: Exception) {
                        progressDialog!!.dismiss()
