...
object LeadActionRepository {
    ...
    private fun getAction(context: Context) {
        ...
        try {
            productWiseComplaintSetterGetter.value = LeadActionActionModel("")
...
//            val call = apiService.getProductDetail(body)
            val call = apiService.getFollowUpAction(body)
            call.enqueue(object : retrofit2.Callback<String> {
                override fun onResponse(
                    ...
                    try {
                        ...
                        productWiseComplaintSetterGetter.value = LeadActionActionModel(msg)
                    } catch (e: Exception) {
                        progressDialog!!.dismiss()
