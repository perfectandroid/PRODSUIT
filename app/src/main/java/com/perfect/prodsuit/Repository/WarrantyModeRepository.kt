            ...
            call.enqueue(object : retrofit2.Callback<String> {
                override fun onResponse(
                    ...
                    try {
                        ...
                        val leads = ArrayList<WarrantyModeModel>()
                        leads.add(WarrantyModeModel(response.body()))
                        val msg = leads[0].message
                        warrantymodeSetterGetter.value = WarrantyModeModel(msg)
                    } catch (e: Exception) {
                        progressDialog!!.dismiss()
