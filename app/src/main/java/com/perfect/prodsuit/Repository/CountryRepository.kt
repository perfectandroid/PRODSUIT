...
object CountryRepository {
    ...
    fun getServicesApiCall(context: Context): MutableLiveData<CountryModel> {
        getCountry(context)
        return coutrySetterGetter
    }

    private fun getCountry(context: Context) {

        Log.e("TAG","getCountry  ")
        try {
            coutrySetterGetter.value = CountryModel("")
