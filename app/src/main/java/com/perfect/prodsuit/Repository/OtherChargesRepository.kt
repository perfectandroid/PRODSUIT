...
object OtherChargesRepository {

    private var progressDialog: ProgressDialog? = null
    val productWiseComplaintSetterGetter = MutableLiveData<OtherActionModel>()
    val TAG: String = "ProductWiseComplaintRepository"

    fun getServicesApiCall(context: Context): MutableLiveData<OtherActionModel> {
        getAction(context)
        return productWiseComplaintSetterGetter
    }

    private fun getAction(context: Context) {

        try {
            productWiseComplaintSetterGetter.value = OtherActionModel("")
            ...
            val call = apiService.getOtherCharges(body)
            call.enqueue(object : retrofit2.Callback<String> {
                override fun onResponse(
                    ...
                    try {
                        ...
                        productWiseComplaintSetterGetter.value = OtherActionModel(msg)
                    } catch (e: Exception) {
                        progressDialog!!.dismiss()
