...
object StockListCategoryRepository {

    private var progressDialog: ProgressDialog? = null
    val stockListCategorySetterGetter = MutableLiveData<StockListCategoryModel>()
    val TAG: String = "StockListCategoryRepository"

    fun getServicesApiCall(context: Context): MutableLiveData<StockListCategoryModel> {
    ...
    private fun getStockListCategory(context: Context) {
        try {
            stockListCategorySetterGetter.value = StockListCategoryModel("")
            ...
            val call = apiService.getStockListCategoryDetails(body)
            call.enqueue(object : retrofit2.Callback<String> {
                override fun onResponse(
                    ...
                    try {
                        ...
                        stockListCategorySetterGetter.value = StockListCategoryModel(msg)
                    } catch (e: Exception) {
                        progressDialog!!.dismiss()
