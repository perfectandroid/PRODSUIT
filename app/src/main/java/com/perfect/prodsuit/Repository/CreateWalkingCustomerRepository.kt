...
object CreateWalkingCustomerRepository {
    ...
    fun getServicesApiCall(context: Context,strCustomer : String,strPhone : String,ID_AssignedTo : String,strAssignedDate : String,strDescription : String,leadByMobileNo : JSONArray): MutableLiveData<CreateWalkingCustomerModel> {
    ...
    private fun CreateWalkingCustomer(context: Context,strCustomer : String,strPhone : String,ID_AssignedTo : String,strAssignedDate : String,strDescription : String,leadByMobileNo : JSONArray) {
        try {
