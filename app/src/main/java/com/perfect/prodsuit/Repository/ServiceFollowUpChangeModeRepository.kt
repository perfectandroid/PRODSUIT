...
object ServiceFollowUpChangeModeRepository {

    var TAG = "ServiceFollowUpChangeModeRepository"
    val serviceFollowUpSetterGetter = MutableLiveData<ServiceFollowUpChangeModeModel>()
    private var progressDialog: ProgressDialog? = null
    fun getServicesApiCall(context: Context,customer_service_register:String,ID_Branch : String , ID_Employee : String): MutableLiveData<ServiceFollowUpChangeModeModel> {
    ...
    private fun getServiceFollowUp(context: Context,customer_service_register:String,ID_Branch : String , ID_Employee : String) {
        try {
            ...
            serviceFollowUpSetterGetter.value = ServiceFollowUpChangeModeModel("")
            ...
            try {
                ...
                requestObject1.put("ReqMode", ProdsuitApplication.encryptStart("87"))
            ...
            val call = apiService.getServiceFollowUpChangeMode(body)
            call.enqueue(object : retrofit2.Callback<String> {
                override fun onResponse(
                    ...
                    try {
                        ...
                        serviceFollowUpSetterGetter.value = ServiceFollowUpChangeModeModel(msg)
                    } catch (e: Exception) {
                        e.printStackTrace()
                        progressDialog!!.dismiss()
