...
object LeadTileRepository {

    private var progressDialog: ProgressDialog? = null
    val serviceCountSetterGetter = MutableLiveData<LeadTileModel>()
    val TAG: String = "LeadTileRepository"

    fun getServicesApiCall(context: Context): MutableLiveData<LeadTileModel> {
