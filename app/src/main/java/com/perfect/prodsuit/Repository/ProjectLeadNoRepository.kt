...
object ProjectLeadNoRepository {
    ...
    fun getServicesApiCall(context: Context,ReqMode : String,SubMode : String): MutableLiveData<ProjectLeadNoModel> {
        getProjectLeadNo(context,ReqMode,SubMode)
        return projectLeadNoSetterGetter
    }

    private fun getProjectLeadNo(context: Context,ReqMode : String,SubMode : String) {
        ...
        try {
            ...
            try {
              ...
              //  {"BankKey":"","FK_Company":"1","ReqMode":"1","SubMode":"2"}
            ...
            val call = apiService.getProjectSiteVisitAssign(body)
