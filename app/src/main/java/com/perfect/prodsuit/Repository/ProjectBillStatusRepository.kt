...
object ProjectBillStatusRepository {

    private var progressDialog: ProgressDialog? = null
    val projectBillSetterGetter = MutableLiveData<ProjectBillStatusModel>()
    val TAG: String = "ProjectBillStatusRepository"

    fun getServicesApiCall(context: Context): MutableLiveData<ProjectBillStatusModel> {
        getProjectBillStatusList(context)
        return projectBillSetterGetter
    }

    private fun getProjectBillStatusList(context: Context) {
        try {
            projectBillSetterGetter.value = ProjectBillStatusModel("")
            ...
            try {
              ...
              requestObject1.put("FK_Employee", ProdsuitApplication.encryptStart(FK_EmployeeSP.getString("FK_Employee", null)))
               ...
               // requestObject1.put("TransDate", ProdsuitApplication.encryptStart("2023-11-17"))
                ...
                requestObject1.put("DashMode", ProdsuitApplication.encryptStart("10"))
                requestObject1.put("DashType", ProdsuitApplication.encryptStart("1"))
                requestObject1.put("ID_TokenUser", ProdsuitApplication.encryptStart(ID_TokenUserSP.getString("ID_TokenUser", null)))



                Log.e(TAG,"project bill 3355  "+requestObject1)
            } catch (e: Exception) {
                e.printStackTrace()
            }
            ...
            call.enqueue(object : retrofit2.Callback<String> {
                override fun onResponse(
                    ...
                    try {
                        ...
                        val salesComparison = ArrayList<ProjectBillStatusModel>()
                        salesComparison.add(ProjectBillStatusModel(response.body()))
                        val msg = salesComparison[0].message
                        projectBillSetterGetter.value = ProjectBillStatusModel(msg)
                    } catch (e: Exception) {
                        progressDialog!!.dismiss()
