...
object PettyCashierRepository {
    ...
    fun getServicesApiCall(context: Context): MutableLiveData<PettyCashierModel> {
        getPettyCashier(context)
        return pettyCashierSetGet
    }

    private fun getPettyCashier(context: Context) {
//        try {
...
//        }
        ...
        try {
            ...
            val msg = "{\n" +
                    ...
                    "      {\n" +
                    "        \"ID_PettyCashier\": \"1\",\n" +
                    "        \"PettyCashier\": \"PettyCashier1\"\n" +
                    "      },\n" +
                    "      {\n" +
                    "        \"ID_PettyCashier\": \"2\",\n" +
                    "        \"PettyCashier\": \"PettyCashier2\"\n" +
                    "      },\n" +
                    "      {\n" +
                    "        \"ID_PettyCashier\": \"3\",\n" +
                    "        \"PettyCashier\": \"PettyCashier3\"\n" +
                    "      },\n" +
                    "      {\n" +
                    "        \"ID_PettyCashier\": \"4\",\n" +
                    "        \"PettyCashier\": \"PettyCashier4\"\n" +
                    "      }\n" +
                    "    ],\n" +
                    "    \"ResponseCode\": \"0\",\n" +
