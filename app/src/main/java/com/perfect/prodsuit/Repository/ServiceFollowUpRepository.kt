...
object ServiceFollowUpRepository {
    ...
    fun getServicesApiCall(context: Context,ID_Branch : String , ID_Employee : String): MutableLiveData<ServiceFollowUpModel> {
        ...
        getServiceFollowUp(context,ID_Branch,ID_Employee)
        return serviceFollowUpSetterGetter
    }
    private fun getServiceFollowUp(context: Context,ID_Branch : String , ID_Employee : String) {
        try {

            Log.v("fsfsfds","branch2 "+ID_Branch)
            serviceFollowUpSetterGetter.value = ServiceFollowUpModel("")
            ...
            try {
                ...
                requestObject1.put("ReqMode", ProdsuitApplication.encryptStart("78"))
                ...
                Log.e(TAG,"requestObject1   83333  "+requestObject1)
            ...
            call.enqueue(object : retrofit2.Callback<String>
            {
                override fun onResponse(
                    ...
                    try {
                        ...
                        serviceFollowUpSetterGetter.value = ServiceFollowUpModel(msg)
                    } catch (e: Exception) {
                        e.printStackTrace()
                        progressDialog!!.dismiss()
