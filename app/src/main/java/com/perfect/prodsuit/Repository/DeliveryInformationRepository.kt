...
object DeliveryInformationRepository {
    ...
    private fun getDeliveryInformation(context: Context,SubMode: String, ID_ProductDelivery: String, TransMode: String) {
        ...
        try {
            ...
            try {
                ...
                Log.e(TAG,"SubMode   11122   "+SubMode)
            ...
            val call = apiService.getDeliveryProductInformationDetails(body)
            call.enqueue(object : retrofit2.Callback<String> {
                override fun onResponse(
                    ...
                    try {
                        ...
                        val leads = ArrayList<DeliveryInformationModel>()
                        leads.add(DeliveryInformationModel(response.body()))
                        val msg = leads[0].message
                        deliveryInfromationSetterGetter.value = DeliveryInformationModel(msg)
                    } catch (e: Exception) {
                        e.printStackTrace()
                        progressDialog!!.dismiss()
