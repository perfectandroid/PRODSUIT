...
object ServiceFollowUpMappedReplacedProductRepository {

    var TAG = "ServiceFollowUpMappedReplacedProductRepository"
    val serviceFollowUpSetterGetter = MutableLiveData<ServiceFollowUpMappedReplacedProductModel>()
    private var progressDialog: ProgressDialog? = null
    fun getServicesApiCall(context: Context,customer_service_register:String,ID_Branch : String , ID_Employee : String): MutableLiveData<ServiceFollowUpMappedReplacedProductModel> {
    ...
    private fun getServiceFollowUp(context: Context,customer_service_register:String,ID_Branch : String , ID_Employee : String) {
        try {
            ...
            serviceFollowUpSetterGetter.value = ServiceFollowUpMappedReplacedProductModel("")
            ...
            try {
                ...
                requestObject1.put("ReqMode", ProdsuitApplication.encryptStart("88"))
            ...
            val call = apiService.getServiceFollowUpMappedReplacedProductList(body)
            call.enqueue(object : retrofit2.Callback<String> {
                override fun onResponse(
                    ...
                    try {
                        ...
                        serviceFollowUpSetterGetter.value = ServiceFollowUpMappedReplacedProductModel(msg)
                    } catch (e: Exception) {
                        e.printStackTrace()
                        progressDialog!!.dismiss()
