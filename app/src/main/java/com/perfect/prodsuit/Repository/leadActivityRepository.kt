...
object leadActivityRepository {

    private var progressDialog: ProgressDialog? = null
    val stockListCategorySetterGetter = MutableLiveData<leadActivityModel>()
    val TAG: String = "StockListCategoryRepository"

    fun getServicesApiCall(context: Context): MutableLiveData<leadActivityModel> {
    ...
    private fun getStockListCategory(context: Context) {
        try {
            stockListCategorySetterGetter.value = leadActivityModel("")
...
//                requestObject1.put("TransDate", ProdsuitApplication.encryptStart(currentDate))
                ...
                Log.e(TAG,"78575  leadActivity  "+requestObject1)
            } catch (e: Exception) {
                e.printStackTrace()
            }
            ...
            val call = apiService.getLeadActivity(body)
            call.enqueue(object : retrofit2.Callback<String> {
                override fun onResponse(
                    ...
                    try {
                        ...
                        stockListCategorySetterGetter.value = leadActivityModel(msg)
                    } catch (e: Exception) {
                        progressDialog!!.dismiss()
