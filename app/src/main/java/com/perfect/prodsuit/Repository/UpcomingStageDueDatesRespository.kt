...
object UpcomingStageDueDatesRespository {
    ...
    fun getServicesApiCall(context: Context): MutableLiveData<UpcomingStageDueDatesModel> {
        getUpcomingStageDueDates(context)
        return upcomingstageDueDatesRespositorysetterGetter
    }


    private fun getUpcomingStageDueDates(context: Context) {
        try {
