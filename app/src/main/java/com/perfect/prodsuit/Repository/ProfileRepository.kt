...
object ProfileRepository {
    ...
    fun getServicesApiCall(context: Context): MutableLiveData<ProfileModel> {
        getprofile(context)
    ...
    private fun getprofile(context: Context) {
        try {
            ...
            try {
                ...
                requestObject1.put("ReqMode", ProdsuitApplication.encryptStart("49"))
            ...
            val call = apiService.getProfile(body)
            call.enqueue(object : retrofit2.Callback<String> {
                override fun onResponse(
                    ...
                    try {
                        ...
                        val users = ArrayList<ProfileModel>()
                        users.add(ProfileModel(response.body()))
                        val msg = users[0].message
                        profileSetterGetter.value = ProfileModel(msg)
                    } catch (e: Exception) {
                        e.printStackTrace()
                        progressDialog!!.dismiss()
