...
object ServiceDetailsRepository {
    ...
    fun getServicesApiCall(context: Context,FK_Product: String, NameCriteria: String): MutableLiveData<ServiceDetailsModel> {
        getServiceDashboard(context,FK_Product,NameCriteria)
        return servicedetailsSetterGetter
    }

    private fun getServiceDashboard(context: Context,FK_Product: String, NameCriteria: String) {
        try {
