...
object LeadOutstandTileRepository {

    private var progressDialog: ProgressDialog? = null
    val leadOutstandTileSetterGetter = MutableLiveData<LeadOutstandTileModel>()
    val TAG: String = "LeadOutstandTileRepository"

    fun getServicesApiCall(context: Context): MutableLiveData<LeadOutstandTileModel> {
        getLeadOutstandTileCount(context)
        return leadOutstandTileSetterGetter
    }

    private fun getLeadOutstandTileCount(context: Context) {
        try {
             ...
             /*   requestObject1.put("BankKey", ProdsuitApplication.encryptStart(BankKeySP.getString("BANK_KEY", null)))
              ...
              requestObject1.put("FK_Employee", ProdsuitApplication.encryptStart(FK_EmployeeSP.getString("FK_Employee", null)))
               // requestObject1.put("FK_Employee", ProdsuitApplication.encryptStart("40"))
                ...
                Log.e(TAG,"78  getLeadoutstand  "+requestObject1)
            } catch (e: Exception) {
                e.printStackTrace()
            }
                ...
                override fun onResponse(
                    ...
                    try {
                       progressDialog!!.dismiss()
                        ...
                        leads.add(LeadOutstandTileModel(response.body()))
                        val msg = leads[0].message
                        leadOutstandTileSetterGetter.value = LeadOutstandTileModel(msg)
                    } catch (e: Exception) {
                        progressDialog!!.dismiss()
