...
object OtherchargeRepository {
    ...
    fun getServicesApiCall(context: Context,ReqMode : String): MutableLiveData<OtherchargeModel> {
...
//                {"ReqMode":"117","EntrBy":"sreejisha","FK_Company":"1"}
            ...
            val call = apiService.getProjectOtherChargeDetails(body)
