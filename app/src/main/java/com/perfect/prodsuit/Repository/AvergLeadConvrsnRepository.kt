...
object AvergLeadConvrsnRepository {

    private var progressDialog: ProgressDialog? = null
    val avgleadconvsnSetterGetter = MutableLiveData<AverageLeadConversionModel>()
    val TAG: String = "AvergLeadConvrsnRepository"

    fun getServicesApiCall(context: Context): MutableLiveData<AverageLeadConversionModel> {
        getAvgLeadConvrsn(context)
        return avgleadconvsnSetterGetter
    }

    private fun getAvgLeadConvrsn(context: Context) {
        try {
            ...
            try {
             ...
             /*   requestObject1.put("BankKey", ProdsuitApplication.encryptStart(BankKeySP.getString("BANK_KEY", null)))
              ...
              //  requestObject1.put("FK_Employee", ProdsuitApplication.encryptStart("40"))
                ...
                Log.e(TAG,"78  getAvgconvsn  "+requestObject1)
            } catch (e: Exception) {
                e.printStackTrace()
            }
                ...
                override fun onResponse(
                    ...
                    try {
                       // progressDialog!!.dismiss()
                        ...
                        leads.add(AverageLeadConversionModel(response.body()))
                        val msg = leads[0].message
                        avgleadconvsnSetterGetter.value = AverageLeadConversionModel(msg)
                    } catch (e: Exception) {
                        progressDialog!!.dismiss()
