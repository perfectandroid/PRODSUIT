...
object ServiceFollowUpServiceTypeRepository {
    ...
    private fun getServiceFollowUp(context: Context,customer_service_register:String,ID_Branch : String , ID_Employee : String) {
        try {
            ...
            serviceFollowUpSetterGetter.value = ServiceFollowUpServiceTypeModel("")
            ...
            try {
                ...
                Log.v("sdasd22efvvv","FK_Employee "+ID_Employee)
                Log.v("sdasd22efvvv","customer_service_register "+customer_service_register)
            ...
            call.enqueue(object : retrofit2.Callback<String> {
                override fun onResponse(
                    ...
                    try {
                        ...
                        serviceFollowUpSetterGetter.value = ServiceFollowUpServiceTypeModel(msg)
                    } catch (e: Exception) {
                        e.printStackTrace()
                        progressDialog!!.dismiss()
