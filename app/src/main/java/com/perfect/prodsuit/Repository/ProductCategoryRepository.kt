...
object ProductCategoryRepository {
    ...
    fun getServicesApiCall(context: Context,ReqMode : String,SubMode : String): MutableLiveData<ProductCategoryModel> {
        getProductCategory(context,ReqMode,SubMode)
        return productcategorySetterGetter
    }

    private fun getProductCategory(context: Context,ReqMode : String,SubMode : String) {
        try {
            productcategorySetterGetter.value = ProductCategoryModel("")
