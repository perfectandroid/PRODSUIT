...
data class ServicePartsReplacedModel(val ID_MasterProduct: String, val MainProduct: String, val ID_Product: String, val Componant: String, val Quantity: String,
