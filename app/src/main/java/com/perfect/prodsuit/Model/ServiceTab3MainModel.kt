...
data class ServiceTab3MainModel(var FK_Product:String, var Product:String, var main:String, var sub:String,
                                ...
                                var ServiceCost:String,var TaxAmount:String,var NetAmount:String,var Remarks:String,var isChecked:Boolean, var FK_TaxGroup:String, var TaxPercentage:String, var ServiceChargeIncludeTax:Boolean,)
