...
data class ActionTakenMainModel(var FK_Product:String, var Product:String, var actionName:String, var ID_Action:String,
                                ...
                                var ID_Emplloyee:String,var EmplloyeeName:String,var ID_Category:String,var Category:String,var ID_SubCategory:String,var ID_Brand:String,var ID_Complaint:String)
