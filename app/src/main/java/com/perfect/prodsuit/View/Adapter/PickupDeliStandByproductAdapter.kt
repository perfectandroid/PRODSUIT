...
class PickupDeliStandByproductAdapter (internal var context: Context, internal var jsonArray: JSONArray):
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    internal val TAG : String = "PickupDeliStandByproductAdapter"
        ...
        try {
            ...
            if (holder is MainViewHolder) {
                ...
                holder.llprodproduct!!.setOnClickListener(View.OnClickListener {
                    clickListener!!.onClick(position, "PickupDeliStandByproduct")
                })
            }
        } catch (e: Exception) {
            e.printStackTrace()
