...
class EmpWiseTargTableAdapter (internal var context: Context, internal var jsonArray: JSONArray):
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        try {
            ...
            if (holder is MainViewHolder) {
                ...
                holder.tvv_Project1.text      = jsonObject!!.getString("EmpFName")
                holder.tvv_ProjectAmount.text = jsonObject!!.getString("ActualAmount").toFloat().toString()
                holder.tvv_Expense.text       = jsonObject!!.getString("TargetAmount").toFloat().toString()
