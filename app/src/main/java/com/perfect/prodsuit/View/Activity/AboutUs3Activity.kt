...
class AboutUs3Activity : AppCompatActivity() , View.OnClickListener {
    ...
    val TAG: String = "AboutUs3Activity"
    ...
    private fun bottombarnav() {
        ...
        chipNavigationBar!!.setOnItemSelectedListener(object : ChipNavigationBar.OnItemSelectedListener{
            override fun onItemSelected(i: Int) {
                when (i) {
                    R.id.home -> {
                        val i = Intent(this@AboutUs3Activity, HomeActivity::class.java)
                        startActivity(i)
                    }
                    R.id.reminder -> {
                        setReminder()
    ...
    private fun doLogout() {
        try {
            ...
            btn_Yes.setOnClickListener {
                dialog1.dismiss()
                dologoutchanges()
                startActivity(Intent(this@AboutUs3Activity, WelcomeActivity::class.java))
            }
            dialog1.show()
        } catch (e: Exception) {
            e.printStackTrace()
