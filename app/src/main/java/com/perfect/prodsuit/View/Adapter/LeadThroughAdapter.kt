...
class LeadThroughAdapter(internal var context: Context, internal var jsonArray: JSONArray):
    RecyclerView.Adapter<RecyclerView.ViewHolder>()  {

    internal val TAG : String = "LeadThroughAdapter"
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val v = LayoutInflater.from(parent.context).inflate(
            R.layout.adapter_lead_through, parent, false
        )
        vh = MainViewHolder(v)
        return vh
    }
    ...
    private inner class MainViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        ...
        internal var llleadthrogh    : LinearLayout
        init {
            txtName        = v.findViewById<View>(R.id.txtName) as TextView
            txtsino        = v.findViewById<View>(R.id.txtsino) as TextView
            llleadthrogh     = v.findViewById<View>(R.id.llleadthrogh) as LinearLayout
        }
    }
