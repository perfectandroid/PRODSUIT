...
//    private var ID_Employee = "";
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mylead)
        context = this@MyLeadActivity
...
//        ID_Employee = FK_EmployeeSP.getString("FK_Employee", null).toString()
    ...
    private fun getMyLead() {
        Log.v("333333    ",""+ID_Employee)
//        var UpcomingDet = 0
        rv_myLeadlist!!.adapter = null
        context = this@MyLeadActivity
        myLeadlistViewModel = ViewModelProvider(this).get(MyLeadListViewModel::class.java)
        when (Config.ConnectivityUtils.isConnected(this)) {
            true -> {
                ...
                progressDialog!!.show()
                myLeadlistViewModel.getMyLeadlist(this,submode!!, name!!, criteria!!, date!!,ID_Branch!!,ID_Employee!!,ID_Lead_Details,strLeadValue)!!.observe(
                        this,
                                ...
                                if (msg!!.length > 0) {
                                    ...
                                    if (UpcomingDet == 0){
                                        ...
                                        if (jObject.getString("StatusCode") == "0") {
                                            ...
                                            val lLayout = GridLayoutManager(this@MyLeadActivity, 1)
                                            rv_myLeadlist!!.layoutManager =
                                                lLayout as RecyclerView.LayoutManager?
                                            rv_myLeadlist!!.setHasFixedSize(true)
                                            val adapter = TodoListAdapter(applicationContext, upcmngtaskArrayList,"4")
...
//            val chk_Message = dialog1 .findViewById(R.id.chk_Message) as CheckBox
            ...
            segmented2.setOnCheckedChangeListener(this@MyLeadActivity);
...
//             val adapter = BranchAdapter(this@LeadGenerationActivity, branchArrayList)
            val adapter = BranchAdapter(this@MyLeadActivity, branchSort)
...
//            val adapter = EmployeeAllAdapter(this@FollowUpActivity, employeeAllArrayList)
            val adapter = EmployeeAllAdapter(this@MyLeadActivity, employeeAllSort)
    ...
    private fun leadDetailPopup(leadDetailArrayList: JSONArray) {
        try {
            ...
            try {
                ...
                val adapter = LeadDetailAdapter(this@MyLeadActivity, leadDetailSort)
