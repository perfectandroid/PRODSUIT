...
class StatusListTicketReportAdapter(internal var context: Context, internal var jsonArray: JSONArray):
    RecyclerView.Adapter<RecyclerView.ViewHolder>()  {

    internal val TAG : String = "StatusListTicketReportAdapter"
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val v = LayoutInflater.from(parent.context).inflate(
            R.layout.adapter_statusticket_report, parent, false
        )
        vh = MainViewHolder(v)
        return vh
    }
