...
class LeadGenerationActivity : AppCompatActivity(), View.OnClickListener, ItemClickListener,ItemClickListenerValue
{
    ...
    private var edtCustaddress1: EditText? = null
    private var edtCustaddress2: EditText? = null
    ...
    private var rcylisting: RecyclerView? = null
    private var btnReset1: Button? = null
    private var editProdcutListarray = JSONArray()
    private var array_product_lead = JSONArray()
    private var llDetailListing: LinearLayout? = null
    private var popup_Dialogue: Dialog? = null
    private var add_product_btn: ImageView? = null
    private var refresh_btn: ImageView? = null
    private var edtScan: ImageView? = null
    private var llrecyvisible: LinearLayout? = null
    private var lldeaillead: LinearLayout? = null
    ...
    var Project = ""
    var clickMode = ""
    var recycle_popup: RecyclerView? = null
    var btnclick = ""
    var MRRP = ""
    var Offerprice = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getGenralSettingsViewModel =
            ViewModelProvider(this).get(GetGenralSettingsViewModel::class.java)
...
//         pausePosition1 =0
      ...
      //  ID_Category = "0"
        ...
        edtEmployee!!.setText("")
        edtAmount!!.setText("")
        editProdcutListarray = JSONArray()
...
//        addmore_btn!!.visibility = View.GONE
    ...
    private fun setRegViews() {
        ...
        rcylisting = findViewById(R.id.rcylisting)
        edtScan = findViewById(R.id.edtScan)
        add_product_btn = findViewById(R.id.add_product_btn)
        refresh_btn = findViewById(R.id.refresh_btn)
        llrecyvisible = findViewById<LinearLayout>(R.id.llrecyvisible)
        recyRequest = findViewById<RecyclerView>(R.id.recyRequest)
        lldeaillead = findViewById(R.id.lldeaillead)
//        addmore_btn = findViewById(R.id.addmore_btn)
...
//                        snackbar.show()
                        Config.snackBars(applicationContext, v, "Enter Pincode")
...
//                    val snackbar: Snackbar = Snackbar.make(v, "Select Country", Snackbar.LENGTH_LONG)
//                    snackbar.setActionTextColor(Color.WHITE)
//                    snackbar.setBackgroundTint(resources.getColor(R.color.colorPrimary))
//                    snackbar.show()
                    Config.snackBars(applicationContext, v, "Select Country")
                } else {
                    Config.disableClick(v)
                    stateDet = 0
                    getState(v)
            ...
            R.id.edtDistrict -> {
                if (FK_States.equals("")) {
//                    val snackbar: Snackbar = Snackbar.make(v, "Select State", Snackbar.LENGTH_LONG)
//                    snackbar.setActionTextColor(Color.WHITE)
//                    snackbar.setBackgroundTint(resources.getColor(R.color.colorPrimary))
//                    snackbar.show()
...
//            }
            ...
            R.id.tv_ProductClick -> {
                ...
                if (custProdlMode.equals("0")) {
                    ...
                    val adapter = LeadGenerationProductListAdapter(
                        this@LeadGenerationActivity,
                        editProdcutListarray
                    )
...
//        popup_Dialogue = Dialog(this)
//        popup_Dialogue!!.requestWindowFeature(Window.FEATURE_NO_TITLE)
//        popup_Dialogue!!.setContentView(R.layout.product_lisiting_popup_lead)
//        popup_Dialogue!!.window!!.attributes.gravity = Gravity.CENTER_VERTICAL
//
//        val window: Window? = popup_Dialogue!!.getWindow()
...
//                    .show()
    ...
    private fun leadFromPopup(leadFromArrayList: JSONArray) {
        ...
        try {
            ...
            val txt_nodata = dialogLeadFrom!! .findViewById(R.id.txt_nodata) as TextView
            ...
            if (leadFromSort.length() <= 0){
                recyLeadFrom!!.visibility = View.GONE
                txt_nodata!!.visibility = View.VISIBLE
            }
...
//            val adapter = LeadFromAdapter(this@LeadGenerationActivity, leadFromArrayList)
            ...
            etsearch!!.addTextChangedListener(object : TextWatcher {
                ...
                override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                    ...
                    if (leadFromSort.length() <= 0){
                        ...
                        recyLeadFrom!!.visibility = View.VISIBLE
                        txt_nodata!!.visibility = View.GONE
                    }
            ...
            dialogLeadFrom!!.show()
            dialogLeadFrom!!.getWindow()!!.setLayout(
                ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT
            );
        } catch (e: Exception) {
                            ...
                            if (msg!!.length > 0) {
                                if (countLeadThrough == 0) {
                                    ...
                                    if (jObject.getString("StatusCode") == "0") {
                                        ...
                                        leadThroughArrayList =
                                            jobjt.getJSONArray("LeadThroughDetails")
...
//                    .show()
    ...
    private fun leadThroghPopup(leadThroughArrayList: JSONArray) {
        ...
        try {
            ...
            val etsearch = dialogLeadThrough!!.findViewById(R.id.etsearch) as EditText

            leadThroughSort = JSONArray()
            for (k in 0 until leadThroughArrayList.length()) {
                val jsonObject = leadThroughArrayList.getJSONObject(k)
                // reportNamesort.put(k,jsonObject)
                leadThroughSort.put(jsonObject)
            }
...
//            val adapter = LeadThroughAdapter(this@LeadGenerationActivity, leadThroughArrayList)
            val adapter = LeadThroughAdapter(this@LeadGenerationActivity, leadThroughSort)
            ...
            etsearch!!.addTextChangedListener(object : TextWatcher {
                ...
                override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                    ...
                    for (k in 0 until leadThroughArrayList.length()) {
                        val jsonObject = leadThroughArrayList.getJSONObject(k)
                        if (textlength <= jsonObject.getString("LeadThroughName").length) {
                            if (jsonObject.getString("LeadThroughName")!!.toLowerCase().trim()
                                    .contains(etsearch!!.text.toString().toLowerCase().trim())
                            ) {
                                leadThroughSort.put(jsonObject)
                            }
                    ...
                    Log.e(TAG, "leadThroughSort               7103    " + leadThroughSort)
                    val adapter = LeadThroughAdapter(this@LeadGenerationActivity, leadThroughSort)
                    recyLeadThrough!!.adapter = adapter
                    adapter.setClickListener(this@LeadGenerationActivity)
                }
            ...
            dialogLeadThrough!!.getWindow()!!.setLayout(
                ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT
            );
        } catch (e: Exception) {
                        ...
                        try {
                            ...
                            if (msg!!.length > 0) {
                                ...
                                if (jObject.getString("StatusCode") == "0") {
                                    ...
                                    leadSubMediaArrayList =
                                        jobjt.getJSONArray("SubMediaTypeDetailsList")
...
//            val adapter = LeadThroughAdapter(this@LeadGenerationActivity, leadSubMediaArrayList)
                ...
                override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                    ...
                    for (k in 0 until leadSubMediaArrayList.length()) {
                        ...
                        if (textlength <= jsonObject.getString("SubMdaName").length) {
                            if (jsonObject.getString("SubMdaName")!!.toLowerCase().trim()
                                    .contains(etsearch!!.text.toString().toLowerCase().trim())
                            ) {
                                leadSubMediaSort.put(jsonObject)
                            }
            ...
            dialogSubMedia!!.show()
            dialogSubMedia!!.getWindow()!!.setLayout(
                ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT
            );
        } catch (e: Exception) {
                            ...
                            if (msg!!.length > 0) {
                                if (countMediatype == 0) {
                                    ...
                                    if (jObject.getString("StatusCode") == "0") {
                                        ...
                                        mediaTypeArrayList =
                                            jobjt.getJSONArray("MediaTypeDetailsList")
...
//            val adapter = MediaTypeAdapter(this@LeadGenerationActivity, mediaTypeArrayList)
                ...
                override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                    ...
                    for (k in 0 until mediaTypeArrayList.length()) {
                        ...
                        if (textlength <= jsonObject.getString("MdaName").length) {
                            if (jsonObject.getString("MdaName")!!.toLowerCase().trim()
                                    .contains(etsearch!!.text.toString().toLowerCase().trim())
                            ) {
                                mediaTypeSort.put(jsonObject)
                            }
            ...
            dialogMediaType!!.getWindow()!!.setLayout(
                ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT
            );
        } catch (e: Exception) {
...
//                                        val jobjt = jObject.getJSONObject("PincodeDetails")
                                        ...
                                        if (pinCodeArrayList.length() == 1) {
                                            ...
                                            Log.e(
                                                TAG,
                                                "Post  21082   " + jsonObject.getString("Post")
                                            )
...
//                    .show()
    ...
    private fun pincodeDetailPopup(pinCodeArrayList: JSONArray) {
        try {
            ...
            val recyPincodeDetails =
                dialogPinCode!!.findViewById(R.id.recyPincodeDetails) as RecyclerView
...
//            recyCustomer!!.setHasFixedSize(true)
            ...
            dialogPinCode!!.show()
            dialogPinCode!!.getWindow()!!.setLayout(
                ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT
            );
...
//            val adapter = PostDetailAdapter(this@LeadGenerationActivity, areaArrayList)
    ...
    private fun validations(v: View) {
        ...
        val Cust_Address1 = edtCustaddress1!!.text.toString()
        val Cust_Address2 = edtCustaddress2!!.text.toString()
        ...
        if (Cust_Name.equals("")) {
            ...
            Customer_Address1 = Cust_Address1
            Customer_Address2 = Cust_Address2
            llCustomerDetail!!.visibility = View.GONE
...
//             val adapter = ProductPriorityAdapter(this@LeadGenerationActivity, prodPriorityArrayList)
            ...
            etsearch!!.addTextChangedListener(object : TextWatcher {
                ...
                override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                    ...
                    val adapter =
                        ProductPriorityAdapter(this@LeadGenerationActivity, prodPrioritySort)
                    recyProdPriority!!.adapter = adapter
                    adapter.setClickListener(this@LeadGenerationActivity)
                }
            })
...
//             val adapter = FollowupActionAdapter(this@LeadGenerationActivity, followUpActionArrayList)
            ...
            etsearch!!.addTextChangedListener(object : TextWatcher {
                ...
                override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                    ...
                    val adapter =
                        FollowupActionAdapter(this@LeadGenerationActivity, followUpActionSort)
                    recyFollowupAction!!.adapter = adapter
                    adapter.setClickListener(this@LeadGenerationActivity)
                }
            })
                            ...
                            if (msg!!.length > 0) {
                                ...
                                if (branchType == 0) {
                                    ...
                                    if (jObject.getString("StatusCode") == "0") {
                                        ...
                                        branchTypeArrayList =
                                            jobjt.getJSONArray("BranchTypeDetailsList")
...
//             val adapter = BranchTypeAdapter(this@LeadGenerationActivity, branchTypeArrayList)
                ...
                override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                    ...
                    for (k in 0 until branchTypeArrayList.length()) {
                        ...
                        if (textlength <= jsonObject.getString("BranchTypeName").length) {
                            if (jsonObject.getString("BranchTypeName")!!.toLowerCase().trim()
                                    .contains(etsearch!!.text.toString().toLowerCase().trim())
                            ) {
                                branchTypeSort.put(jsonObject)
                            }
            ...
            dialogBranchType!!.getWindow()!!.setLayout(
                ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT
            );
        } catch (e: Exception) {
...
//            editProdcutListarray.remove(position)
        ...
        if (data.equals("editArrayList")) {
            try {
                ...
                edtProdfeedback!!.setText("" + jsonObject!!.getString("LgpDescription"))
                edtProdqty!!.setText("" + jsonObject!!.getString("LgpPQuantity"))
                edtFollowaction!!.setText("" + jsonObject!!.getString("NxtActnName"))
                edtFollowtype!!.setText("" + jsonObject!!.getString("ActionTypeName"))
...
//                    viewList(editProdcutListarray)
//                } else {
//                    lllistdetails!!.visibility = View.GONE
//                    rcylisting!!.adapter = null
//                }
...
//            val jsonObject = leadThroughArrayList.getJSONObject(position)
            val jsonObject = leadThroughSort.getJSONObject(position)
...
//            mediaPlayer.start()
    ...
    private fun LeadValidations(v: View) {
        ...
        Log.e(
            TAG,
            "LeadValidations  3732   " + ID_CustomerAssignment + "  " + ID_CustomerAssignment!!.length
        )
...
//            else if (Customer_Address1.equals("")){
...
//        saveLeadGeneration()
    ...
    private fun LeadConfirmationPopup() {
        try {
            ...
            dialogConfirmPop!!.setContentView(R.layout.confirmation_pop_lead)
            ...
            val ll_LeadDetails =
                dialogConfirmPop!!.findViewById(R.id.ll_LeadDetails) as LinearLayout
            val ll_lead_date = dialogConfirmPop!!.findViewById(R.id.ll_lead_date) as LinearLayout
            val ll_collected_by =
                dialogConfirmPop!!.findViewById(R.id.ll_collected_by) as LinearLayout
            val ll_lead_source =
                dialogConfirmPop!!.findViewById(R.id.ll_lead_source) as LinearLayout
            val ll_lead_from = dialogConfirmPop!!.findViewById(R.id.ll_lead_from) as LinearLayout
            val ll_lead_SubMedia =
                dialogConfirmPop!!.findViewById(R.id.ll_lead_SubMedia) as LinearLayout

            val tvp_lead_date = dialogConfirmPop!!.findViewById(R.id.tvp_lead_date) as TextView
            val tvp_collected_by =
                dialogConfirmPop!!.findViewById(R.id.tvp_collected_by) as TextView
            ...
            val tvp_lead_from_label =
                dialogConfirmPop!!.findViewById(R.id.tvp_lead_from_label) as TextView
            val tvp_lead_SubMedia =
                dialogConfirmPop!!.findViewById(R.id.tvp_lead_SubMedia) as TextView


            ////////////////////////
            val ll_CustomerDetail =
            ...
            val ll_cust_email = dialogConfirmPop!!.findViewById(R.id.ll_cust_email) as LinearLayout
            val ll_cust_address =
                dialogConfirmPop!!.findViewById(R.id.ll_cust_address) as LinearLayout
            val ll_cust_address2 =
                dialogConfirmPop!!.findViewById(R.id.ll_cust_address2) as LinearLayout
            val ll_cust_address3 =
                dialogConfirmPop!!.findViewById(R.id.ll_cust_address3) as LinearLayout
            ...
            val tvp_cust_address =
                dialogConfirmPop!!.findViewById(R.id.tvp_cust_address) as TextView
            val tvp_cust_address2 =
                dialogConfirmPop!!.findViewById(R.id.tvp_cust_address2) as TextView
            val tvp_cust_address3 =
                dialogConfirmPop!!.findViewById(R.id.tvp_cust_address3) as TextView


            ////////////////////////
            val ll_MoreCommunicationInfo =
                dialogConfirmPop!!.findViewById(R.id.ll_MoreCommunicationInfo) as LinearLayout
            val ll_cust_country =
                dialogConfirmPop!!.findViewById(R.id.ll_cust_country) as LinearLayout
            val ll_cust_state = dialogConfirmPop!!.findViewById(R.id.ll_cust_state) as LinearLayout
            val ll_cust_district =
                dialogConfirmPop!!.findViewById(R.id.ll_cust_district) as LinearLayout
            val ll_cust_post = dialogConfirmPop!!.findViewById(R.id.ll_cust_post) as LinearLayout
            val ll_cust_pincode =
                dialogConfirmPop!!.findViewById(R.id.ll_cust_pincode) as LinearLayout
            ...
            val tvp_cust_district =
                dialogConfirmPop!!.findViewById(R.id.tvp_cust_district) as TextView
            val tvp_cust_post = dialogConfirmPop!!.findViewById(R.id.tvp_cust_post) as TextView
            val tvp_cust_pincode =
            ...
            ////////////////////////
//            val ll_ProductDetails =
//                dialogConfirmPop!!.findViewById(R.id.ll_ProductDetails) as LinearLayout
//            val ll_prod_category =
//                dialogConfirmPop!!.findViewById(R.id.ll_prod_category) as LinearLayout
//            val ll_prod_product =
//                dialogConfirmPop!!.findViewById(R.id.ll_prod_product) as LinearLayout
...
//            val ll_expected_date =
//                dialogConfirmPop!!.findViewById(R.id.ll_expected_date) as LinearLayout
...
//                dialogConfirmPop!!.findViewById(R.id.ll_prod_feedback) as LinearLayout
//
//            val ll_followup = dialogConfirmPop!!.findViewById(R.id.ll_followup) as LinearLayout
//            val ll_followup_action =
//                dialogConfirmPop!!.findViewById(R.id.ll_followup_action) as LinearLayout
//            val ll_followup_type =
//                dialogConfirmPop!!.findViewById(R.id.ll_followup_type) as LinearLayout
//            val ll_followup_date =
//                dialogConfirmPop!!.findViewById(R.id.ll_followup_date) as LinearLayout
...
//
//            val tvp_company_name =
//                dialogConfirmPop!!.findViewById(R.id.tvp_company_name) as TextView
//            val tvp_contact_person =
//                dialogConfirmPop!!.findViewById(R.id.tvp_contact_person) as TextView
//            val tvp_contact_number =
...
//
//            val tvp_label_product =
//                dialogConfirmPop!!.findViewById(R.id.tvp_label_product) as TextView
//            val tvp_product_label =
//                dialogConfirmPop!!.findViewById(R.id.tvp_product_label) as TextView
//            val tvp_project_label =
//                dialogConfirmPop!!.findViewById(R.id.tvp_project_label) as TextView
//            val tvp_quantity_label =
//                dialogConfirmPop!!.findViewById(R.id.tvp_quantity_label) as TextView
//
...
//            val tvp_expected_date =
//                dialogConfirmPop!!.findViewById(R.id.tvp_expected_date) as TextView
...
//            val tvp_followup_action =
//                dialogConfirmPop!!.findViewById(R.id.tvp_followup_action) as TextView
//            val tvp_followup_type =
//                dialogConfirmPop!!.findViewById(R.id.tvp_followup_type) as TextView
//            val tvp_followup_date =
//                dialogConfirmPop!!.findViewById(R.id.tvp_followup_date) as TextView
...
//
            val lLayout = GridLayoutManager(this@LeadGenerationActivity, 1)
            recycle_popup!!.layoutManager = lLayout as RecyclerView.LayoutManager?
            val adapter = Popconfirmation_lead_adapter(this@LeadGenerationActivity, editProdcutListarray)
            recycle_popup!!.adapter = adapter
            adapter.setClickListener(this@LeadGenerationActivity)
            ...
            val ll_LocationDetails =
                dialogConfirmPop!!.findViewById(R.id.ll_LocationDetails) as LinearLayout


            ///////////

            val ll_company_name =
                dialogConfirmPop!!.findViewById(R.id.ll_company_name) as LinearLayout
            val ll_contact_person =
                dialogConfirmPop!!.findViewById(R.id.ll_contact_person) as LinearLayout
            val ll_contact_number =
                dialogConfirmPop!!.findViewById(R.id.ll_contact_number) as LinearLayout
            ...
            if (edtCustname!!.text.toString().equals("")) {
                ll_cust_name!!.visibility = View.GONE
            }
            ...
            if (edtCompanyContact!!.text.toString().equals("")) {
                ll_company_contact!!.visibility = View.GONE
            }
            if (edtCustemail!!.text.toString().equals("")) {
                ll_cust_email!!.visibility = View.GONE
            }
            if (edtCustaddress1!!.text.toString().equals("")) {
                ll_cust_address!!.visibility = View.GONE
            }
            if (edtCustaddress2!!.text.toString().equals("")) {
                ll_cust_address2!!.visibility = View.GONE
            }
            if (edtArea!!.text.toString().equals("")) {
                ll_cust_address3!!.visibility = View.GONE
            }



            if (edtCountry!!.text.toString().equals("")) {
                ll_cust_country!!.visibility = View.GONE
            }

            if (edtState!!.text.toString().equals("")) {
                ll_cust_state!!.visibility = View.GONE
            }

            if (edtDistrict!!.text.toString().equals("")) {
                ll_cust_district!!.visibility = View.GONE
            }

            if (edtPost!!.text.toString().equals("")) {
                ll_cust_post!!.visibility = View.GONE
            }

            if (edtPincode!!.text.toString().equals("")) {
                ll_cust_pincode!!.visibility = View.GONE
            }
...
//            }
            ...
            if (FK_Country.equals("") && FK_States.equals("") && FK_District.equals("") && FK_Post.equals(
                    ""
                ) && edtPincode!!.text.toString().equals("")
            ) {
                ll_MoreCommunicationInfo!!.visibility = View.GONE
            }
...
//            if (edtProdcategory!!.text.toString().equals("")) {
//                ll_prod_category!!.visibility = View.GONE
//            }
//
...
//                ll_branchtype!!.visibility = View.GONE
//            }
//
//            if (edtbranch!!.text.toString().equals("")) {
//                ll_branch!!.visibility = View.GONE
//            }
//
//            if (edtdepartment!!.text.toString().equals("")) {
//                ll_department!!.visibility = View.GONE
//            }
//
//
//            if (edtEmployee!!.text.toString().equals("")) {
//                ll_employee!!.visibility = View.GONE
//            }
            ...
            tvp_cust_address2.text = edtCustaddress2!!.text.toString()
            tvp_cust_address3.text = edtArea!!.text.toString()
            ...
            tvp_cust_landline.text = edtWhatsApp!!.text.toString()
...
//            }
            ...
            e.printStackTrace()
            Log.e("fsgsfg","bbbbbbbbbbbbbbbbbb"+e)
        }
    }
...
//                                pinCodeDet++
                                if (msg!!.length > 0) {
                                    ...
                                    if (editLeadGenDet == 0) {
                                        ...
                                        if (jObject.getString("StatusCode") == "0") {
                                            val jobjt =
                                                jObject.getJSONObject("LeadGenerationDetails")
                                            leadEditArrayList =
                                                jobjt.getJSONArray("LeadGenerationDetailsList")
...
//            val adapter = LeadEditDetailAdapter(this@LeadGenerationActivity, leadEditArrayList)
                ...
                override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                    ...
                    for (k in 0 until leadEditArrayList.length()) {
                        ...
                        if (textlength <= jsonObject.getString("CustomerName").length) {
                            if (jsonObject.getString("CustomerName")!!.toLowerCase().trim()
                                    .contains(etsearch!!.text.toString().toLowerCase().trim())
                            ) {
                                leadEditSort.put(jsonObject)
                            }
            ...
            dialogLeadEdit!!.show()
            dialogLeadEdit!!.getWindow()!!.setLayout(
                ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT
            );
        } catch (e: Exception) {
        ...
        try {
            when (Config.ConnectivityUtils.isConnected(this)) {
                true -> {
                    ...
                    progressDialog!!.show()
                    Config.Utils.hideSoftKeyBoard(this, edt_customer!!)
                    leadEditDetailViewModel.getLeadEditDetail(
                        this,
                        ID_LeadGenerate,
                        ID_LeadGenerateProduct
                    )!!.observe(
...
//                                pinCodeDet++
                                if (msg!!.length > 0) {
                                    ...
                                    if (jObject.getString("StatusCode") == "0") {
                                        val jobjt =
                                            jObject.getJSONObject("LeadGenerationListDetails")

                                        Log.e(
                                            TAG,
                                            "ID_LeadGenerateProduct   4366   " + jobjt.getString("ID_LeadGenerateProduct")
                                        )
                                        ...
                                        edtCustaddress1!!.setText(jobjt.getString("LgCusAddress"))
                                        ...
                                        edtDistrict!!.setText(jobjt.getString("District"))
                                        edtPost!!.setText(jobjt.getString("Post"))
                                        edtWhatsApp!!.setText(jobjt.getString("CusPhone"))
                                        ...
                                        edtAmount!!.setText(jobjt.getString("LgpSalesPrice"))

//                                        val jObject = JSONObject()
//
//                                        jObject.put("CategoryName",jobjt.getString("CategoryName"))
//                                        jObject.put("ProdName",jobjt.getString("ProdName"))
//                                        jObject.put("PriorityName",jobjt.getString("PriorityName"))
//                                        jObject.put("LgpDescription",jobjt.getString("LgpDescription"))
//                                        jObject.put("LgpPQuantity",jobjt.getString("LgpPQuantity"))
//                                        jObject.put("ActionName",jobjt.getString("ActionName"))
//                                        jObject.put("ActionTypeName",jobjt.getString("ActionTypeName"))
...
//                                        strDate = jobjt.getString("LocLatitude")
                                        ...
                                        if (!LandMark1!!.isEmpty()) {
                                            ...
                                            Glide.with(this@LeadGenerationActivity)
                                                .load(stream.toByteArray())
                                                .placeholder(R.drawable.lead_uploads)
                                                .error(R.drawable.lead_uploads).into(imgvupload1!!)
                                        }
                                        ...
                                        if (!LandMark2!!.isEmpty()) {
                                            ...
                                            Glide.with(this@LeadGenerationActivity)
                                                .load(stream.toByteArray())
                                                .placeholder(R.drawable.lead_uploads)
                                                .error(R.drawable.lead_uploads).into(imgvupload2!!)
                                        }
...
//                        .show()
    ...
    fun multipleProductValidation(v: View): String {
...
//        strFollowupdate,
        ...
        for (i in 0 until editProdcutListarray.length()) {
            ...
            if (jsonObject.getString("ID_Product")!!.equals("")) {
                ...
                jObject.put("LgpPQuantity",(jsonObject.getString("LgpPQuantity")))
                jObject.put("FK_Priority", (jsonObject.getString("ID_Priority")))
                jObject.put("LgpDescription", (jsonObject.getString("LgpDescription")))
...
//                jObject.put("FK_ProductLocation", ID_ProductLocation)
    ...
    private fun viewList(editProdcutListarray: JSONArray) {
        ...
        rcylisting!!.layoutManager = lLayout as RecyclerView.LayoutManager?
        val adapter =
            LeadGenerationProductListAdapter(this@LeadGenerationActivity, editProdcutListarray)
        rcylisting!!.adapter = adapter
        adapter.setClickListener(this@LeadGenerationActivity)
