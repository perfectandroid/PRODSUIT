...
class CrmStageChartAdapter(internal var context: Context, internal var jsonArray: JSONArray):
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        try {
            ...
            if (holder is MainViewHolder) {
                ...
                holder.tv_value.text        = jsonObject!!.getString("StatusCount").toFloat().toInt().toString()
