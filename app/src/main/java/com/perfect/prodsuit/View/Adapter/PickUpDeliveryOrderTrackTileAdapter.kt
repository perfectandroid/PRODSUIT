...
class PickUpDeliveryOrderTrackTileAdapter(internal var context: Context, internal var jsonArray: JSONArray, internal var remark: String):
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    internal val TAG : String = "PickUpDeliveryOrderTrackTileAdapter"
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val v = LayoutInflater.from(parent.context).inflate(
            R.layout.adapter_pickupdelevry_ordertrack, parent, false
        )
        vh = MainViewHolder(v)
        return vh
    }
