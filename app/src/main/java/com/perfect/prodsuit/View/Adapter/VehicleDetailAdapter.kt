...
class VehicleDetailAdapter (internal var context: Context, internal var jsonArray: JSONArray):
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        try {
            ...
            if (holder is MainViewHolder) {
                ...
                holder.tvv_Project.text = jsonObject!!.getString("Vehicle")
                holder.tvv_ActualPeriod.text = jsonObject!!.getString("Pickup")
                holder.tvv_CurrentPeriod.text = jsonObject!!.getString("Delivery")
