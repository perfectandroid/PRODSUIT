...
class ServiceActivity : AppCompatActivity() , View.OnClickListener {
    ...
    private fun setRegViews() {
        ...
        llServiceFollowup = findViewById<LinearLayout>(R.id.llServiceFollowup)
        llCustomerService!!.setOnClickListener(this)
        llServiceAssign!!.setOnClickListener(this)
        llServiceFollowup!!.setOnClickListener(this)
    }
    ...
    private fun bottombarnav() {
        ...
        chipNavigationBar!!.setOnItemSelectedListener(object : ChipNavigationBar.OnItemSelectedListener{
            override fun onItemSelected(i: Int) {
                when (i) {
                    R.id.home -> {
                        val i = Intent(this@ServiceActivity, HomeActivity::class.java)
                        startActivity(i)
                    }
                    R.id.reminder -> {
                        setReminder()
    ...
    private fun doLogout() {
        try {
            ...
            btn_Yes.setOnClickListener {
                dialog1.dismiss()
                dologoutchanges()
                startActivity(Intent(this@ServiceActivity, WelcomeActivity::class.java))
            }
            dialog1.show()
        } catch (e: Exception) {
            e.printStackTrace()
