...
class AccountSupplierDashAdapter(internal var context: Context, internal var jsonArray: JSONArray):
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    internal val TAG : String = "AccountSupplierDashAdapter"
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val v = LayoutInflater.from(parent.context).inflate(
            R.layout.adapter_account_suplier_dash, parent, false
        )
        vh = MainViewHolder(v)
        return vh
    }
...
//                holder.ll_main.setBackgroundColor(randomColor)
                ...
                holder.tv_label.text        = jsonObject!!.getString("Supplier")
                holder.tv_value.text        = Config.changeTwoDecimel(jsonObject!!.getString("Amount").toString())
