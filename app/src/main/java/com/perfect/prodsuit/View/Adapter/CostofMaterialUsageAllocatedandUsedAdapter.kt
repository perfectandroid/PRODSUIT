...
class CostofMaterialUsageAllocatedandUsedAdapter (internal var context: Context, internal var jsonArray: JSONArray):
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        try {
            ...
            if (holder is MainViewHolder) {
                ...
                holder.tvv_Allocated.text        = jsonObject!!.getString("Allocated")
                holder.tvv_Usage.text            = jsonObject!!.getString("Usage")
...
//                })
    ...
    private inner class MainViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        ...
        internal var tvv_Allocated       : TextView
        internal var tvv_Usage           : TextView
        init {
            tvv_slnmbr         = v.findViewById<View>(R.id.tvv_slnmbr)    as TextView
            tvv_Project        = v.findViewById<View>(R.id.tvv_Project)   as TextView
            tvv_Allocated      = v.findViewById<View>(R.id.tvv_Allocated) as TextView
            tvv_Usage          = v.findViewById<View>(R.id.tvv_Usage)     as TextView
        }
    }
