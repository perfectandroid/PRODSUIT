...
import com.perfect.prodsuit.Helper.AlarmHelper.setReminder
...
//                    setReminder("","You have set reminder for following defaulters accounts "+lstChkArray.toString(),strReminder)
...
//                chipNavigationBar!!.setItemSelected(R.id.home, true)
            ...
            btnsubmit.setOnClickListener {
                ...
                if (isPreviousTime(dateShow, hr, min)) {
                    ...
                    Log.v("sdasdsdsdsd333", "startTime "+startTime)
                    Log.v("sdasdsdsdsd333", "min "+min)
...
Log.v("sfsdfsdfdd","time "+""+ihour+":"+imin);
Log.v("sfsdfsdfdd","timeShow "+timeShow);
