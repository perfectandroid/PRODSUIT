...
class ProductCategoryAdapter1(internal var context: Context, internal var jsonArray: JSONArray):
...
//                    holder.txtCategory.setTextColor(context.getColor(R.color.red))
//                }
//                if (position % 2 == 0){
