...
class Upcoming_Due_Date_Adapter (internal var context: Context, internal var jsonArray: JSONArray):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val v = LayoutInflater.from(parent.context).inflate(
            R.layout.adapter_upcoming_due_dates, parent, false
        )
        vh = MainViewHolder(v)
        return vh
    }
    ...
    private inner class MainViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        ...
        init {
            ...
            tvv_DueDate       = v.findViewById<View>(R.id.tvv_DueDate) as TextView
        }
    }
