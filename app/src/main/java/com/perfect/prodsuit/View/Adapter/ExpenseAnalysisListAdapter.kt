...
class ExpenseAnalysisListAdapter (internal var context: Context, internal var jsonArray: JSONArray):
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        try {
            ...
            if (holder is MainViewHolder) {
                ...
                holder.tvv_Project1.text      = jsonObject!!.getString("Project")
                holder.tvv_ProjectAmount.text = jsonObject!!.getString("ProjectAmount").toFloat().toString()
                holder.tvv_Expense.text       = jsonObject!!.getString("Expense").toFloat().toString()
