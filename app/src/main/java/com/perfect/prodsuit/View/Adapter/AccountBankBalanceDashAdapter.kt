...
class AccountBankBalanceDashAdapter(internal var context: Context, internal var jsonArray: JSONArray):
...
//                holder.ll_main.setBackgroundColor(randomColor)
                ...
                holder.tv_label.text        = jsonObject!!.getString("BankAccount")
                holder.tv_value.text        = Config.changeTwoDecimel(jsonObject!!.getString("Balance").toString())
