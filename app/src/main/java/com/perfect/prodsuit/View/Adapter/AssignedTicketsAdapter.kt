...
class AssignedTicketsAdapter (internal var context: Context, internal var jsonArray: JSONArray):
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    internal val TAG : String = "AssignedTicketsAdapter"
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val v = LayoutInflater.from(parent.context).inflate(
            R.layout.adapter_assigned_ticket, parent, false
        )
        vh = MainViewHolder(v)
        return vh
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        try {
            ...
            if (holder is MainViewHolder) {
                ...
                holder.txtv_Visitdate.text        = jsonObject!!.getString("VisitDate")
                holder.txtv_Visittime.text        = jsonObject!!.getString("VisitTime")
...
//                colorAnim.start()
    ...
    private inner class MainViewHolder(v: View) : RecyclerView.ViewHolder(v) {
       ...
       internal var txtv_Visitdate          : TextView
        internal var txtv_Visittime          : TextView


        init {
            txtv_ticketno        = v.findViewById<View>(R.id.txtv_ticketno) as TextView
            txtv_Visitdate        = v.findViewById<View>(R.id.txtv_Visitdate) as TextView
            txtv_Visittime        = v.findViewById<View>(R.id.txtv_Visittime) as TextView
